...
//	return 0;
	...
	case 9: //tPSI
		...
		if (argv[7][0] == '-' && argv[7][1] == 'p')
		{
			...
			// our mPSI in the malicious setting
			tpsi_party(pIdx, nParties, tParties, setSize, SimulatedOkvs, secMalicious);

			// our mPSI-CA in the malicious setting
			//tpsi_ca(pIdx, nParties, tParties, setSize, SimulatedOkvs, secMalicious);
